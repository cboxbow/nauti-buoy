...
function HeroSection() {
  ...
  return (
    <section id="hero" className="relative w-full h-screen min-h-[600px] overflow-hidden flex items-center justify-center">
      ...
      >
        {muted
          ? <><VolumeX className="w-4 h-4" /><span className="hidden sm:inline">Son</span></>
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white/90 text-sm">
            ...
            Nord de l'Île Maurice · Excursions en mer
          </div>
        </motion.div>
        ...
        >
          Découvrez Maurice<br />
          <span style={{ color: '#00CFC8' }}>Comme Jamais Avant</span>
        </motion.h1>
        ...
        >
          Escapade privée dans le lagon cristallin du Nord 🇲🇺<br />
          Flat Island · Gabriel Island · Coin de Mire · BBQ all-inclusive
        </motion.p>
